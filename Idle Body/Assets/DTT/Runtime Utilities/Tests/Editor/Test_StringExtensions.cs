...
namespace DTT.Utils.Tests
{
    ...
    public class Test_StringExtensions
    {
        ...
        public void Test_IsValidVariableName_Null_String()
        {
            ...
            // Act.
            TestDelegate action = () => @string.IsValidVariableName();
        ...
        {
            // Arrange.
            string @string = "MyCustomVariableName";

            // Act.
            bool condition = @string.IsValidVariableName();

            // Assert.
            Assert.IsTrue(condition, $"Expected the variable name {@string} to be a valid variable name but it wasn't.");
        }
        ...
        {
            // Arrange.
            string @string = "MyCustom/VariableName";

            // Act.
            bool condition = @string.IsValidVariableName();

            // Assert.
            Assert.IsFalse(condition, $"Expected the variable name {@string} not to be a valid variable name but it was.");
        }
        #endregion
    }
}
